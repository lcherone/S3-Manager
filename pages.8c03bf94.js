...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/pages/index.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    open: function open(item) {
      this.$nextTick(function () {
        this.$router.push("/host/".concat(item));
      });
    }
  }
};
exports.default = _default;
        var $cfb812 = exports.default || module.exports;
      
      if (typeof $cfb812 === 'function') {
        $cfb812 = $cfb812.options;
      }
    
        /* template */
        Object.assign($cfb812, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.state.authenticated
    ? _c("article", { staticClass: "content container-fluid" }, [
        _c("section", [
          _c("h1", { staticClass: "page-header" }, [_vm._v("Hosts")]),
          _vm._v(" "),
            ...
            _c(
              ...
              [
                _c("table", { staticClass: "table table-sm" }, [
                  ...
                  _c(
                    "tbody",
                    _vm._l(_vm.state.hosts, function(host, key) {
                      return _c("tr", { key: key }, [
                        _c("th", { attrs: { scope: "row" } }, [
                          _vm._v(_vm._s(key))
                        ]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(host.url))]),
                        _vm._v(" "),
                        _c("td", { staticClass: "text-right" }, [
                          host.accessKey && host.secretKey
                            ? _c(
                                "span",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cfb812', $cfb812);
          } else {
            api.reload('$cfb812', $cfb812);
          }
        }
...
//# sourceMappingURL=/pages.8c03bf94.js.map