...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/pages/login.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  beforeMount: function beforeMount() {
    if (typeof localStorage.auth_set === 'undefined' || typeof localStorage.state === 'undefined') {
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      try {
        // decrypt
        state = _aes.default.decrypt(localStorage.state, this.form.values.password).toString(_encUtf.default); // json parse
      ...
      this.$set(this.state, 'loading', true); // set password into state for saving
...
exports.default = _default;
        var $ffe9c6 = exports.default || module.exports;
      
      if (typeof $ffe9c6 === 'function') {
        $ffe9c6 = $ffe9c6.options;
      }
    
        /* template */
        Object.assign($ffe9c6, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("article", { staticClass: "container-fluid py-5" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-12 col-md-8 col-lg-6 col-xl-4 mx-auto" }, [
        _c("div", { staticClass: "bg-white shadow p-4" }, [
          _c(
            "h1",
            { staticClass: "h3 pb-2 border-bottom" },
            [_c("fa", { attrs: { icon: "lock" } }), _vm._v(" Login\n        ")],
            1
          ),
          _vm._v(" "),
          _c("p", { staticClass: "text-center py-2" }, [
            _vm._v("Welcome back! Enter your password to unlock your hosts.")
          ]),
          _vm._v(" "),
          _c(
            "form",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ffe9c6', $ffe9c6);
          } else {
            api.reload('$ffe9c6', $ffe9c6);
          }
        }
...
//# sourceMappingURL=/login.2569ed71.js.map